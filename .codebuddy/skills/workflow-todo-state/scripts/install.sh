...
Options:
  ...
  --entry-file FILE Project instruction file to update (default: CODEBUDDY.md for the historical .claude profile).
...
SCRIPTS_DIR=".codebuddy/scripts"
WORKFLOWS_DIR=".codebuddy/workflows"
ENTRY_FILE="CODEBUDDY.md"
...
load_profile() {
  ...
  case "$name" in
    codex)
      ...
      ;;
    claude)
      AGENT_DIR=".claude"; SKILLS_DIR=".codebuddy/skills"; RULES_DIR=".codebuddy/rules"; SCRIPTS_DIR=".codebuddy/scripts"; WORKFLOWS_DIR=".codebuddy/workflows"; ENTRY_FILE="CODEBUDDY.md"
      ;;
    generic)
