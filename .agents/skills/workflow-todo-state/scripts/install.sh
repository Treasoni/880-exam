...
Options:
  ...
  --entry-file FILE Project instruction file to update (default: AGENTS.md for the historical .claude profile).
...
load_profile() {
  ...
  case "$name" in
    codex)
      ...
      ;;
    claude)
      AGENT_DIR=".claude"; SKILLS_DIR=".agents/skills"; RULES_DIR=".codex/rules"; SCRIPTS_DIR=".codex/scripts"; WORKFLOWS_DIR=".codex/workflows"; ENTRY_FILE="AGENTS.md"
      ;;
    generic)
