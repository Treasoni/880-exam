...
完整技能表见 `.codebuddy/rules/common/skill-invocation.md`。涉及拼卷/判分/错题本/预览/入库的操作，先读 `.codebuddy/rules/workflow-routing.md` 匹配 `880-exam` 工作流。
...
<!-- obsidian-content:codebuddy:begin -->
## Obsidian 内容规范

- 生成任何 Markdown 内容（880 产物的卷子/答案卷/错题本/进度总览，以及文档、ADR、笔记、报告）时，遵循 `.codebuddy/rules/common/obsidian-content.md`。
...
<!-- obsidian-content:codebuddy:end -->
